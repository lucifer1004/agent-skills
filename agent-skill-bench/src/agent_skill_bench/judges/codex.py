    ...
    def evaluate_case(
        ...
        *,
        ...
        with TemporaryDirectory(prefix="agent-skill-bench-judge-") as tmp_dir:
            ...
            schema_path.write_text(json.dumps(_judge_schema(), indent=2), encoding="utf-8")
            ...
            completed = subprocess.run(
                ...
                input=_judge_prompt(case, output_text, rule_evaluation),
            )
...
def _judge_prompt(
    ...
    """Build a generic, domain-agnostic benchmark judge prompt."""
    ...
    sections.extend(
        [
            ...
            "- actionability",
            "",
            "Set passed=true only if the output is broadly benchmark-worthy, not merely acceptable.",
